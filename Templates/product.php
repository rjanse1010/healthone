...
//        var_dump($fRating);
        if($fRating >= 1 && $fRating <= 5) {
            saveReview($fName, $fTitle, $fContent, $fRating, $productId);
        } else {
    ...
    if($rating == null) {
        echo "<p>Er zijn nog geen reviews, laat hieronder jouw feedback achter.</p>";
    } else {
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">“<?=$review->text?>” - <?=$review->name?></p>
        ...
        <div class="modal-body">
            <form id="reviewform" method="post">
                <div class="mb-3">
                    ...
                    <input name="name" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Pieter Henk" required>
                </div>
                <div class="mb-3">
